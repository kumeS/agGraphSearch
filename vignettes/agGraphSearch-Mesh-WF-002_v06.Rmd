...
words$subjectLabel[n]  <- DeePL(words$subjectLabel[n], Auth_Key="43725ffd-d3d3-a301-c92d-8d7e2070f71c:fx")
...
#Translate to Japanese 
words$parentClassLabel[n] <- DeePL(words$parentClassLabel[n], Auth_Key="43725ffd-d3d3-a301-c92d-8d7e2070f71c:fx")
}
...
Dat02 <- readRDS("./02_Mesh_Out/Dat02_UpperClass.Rds")
head(Dat02)
