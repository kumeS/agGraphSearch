...
saveRDS(terms, file="./01_Short_Out/SearchEntities.Rdata")
```
...
saveRDS(QID, file="./02_Short_Out/SearchEntities.Rdata")
```
...
readr::write_excel_csv(Count_upEntity_DF2,
                       file=paste("./03_Short_Out/Count_upEntity_DF2.csv", sep=""))
...
#Search entities
list1a <- readRDS("./01_Short_Out/SearchEntities.Rdata")
head(QID_rdfsLabel)
