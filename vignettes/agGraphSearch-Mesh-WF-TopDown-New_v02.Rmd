...
bb2 <- bb1[!(bb1$IDs %in% unique(aa1$IDs)),]
...
Jpn <- DeePL(aa, Auth_Key="43725ffd-d3d3-a301-c92d-8d7e2070f71c:fx")
bb3[k,2] <- Jpn
...
#ここから9/8
#saveRDS(DatJpn02, "./02_Mesh_Out/OCR_DatJpn02_new.Rds")
##################################################################
