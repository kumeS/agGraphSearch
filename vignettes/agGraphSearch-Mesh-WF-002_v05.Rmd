...
saveRDS(Count_upEntity_DF3,
        file = "./03_Short_Out/Count_upEntity_DF3.Rds", compress = TRUE)
readr::write_excel_csv(Count_upEntity_DF3,
                       file="./03_Short_Out/Count_upEntity_DF3.csv")
#Count_upEntity_DF3 <- readRDS(file = "./03_Short_Out/Count_upEntity_DF3.Rds")
