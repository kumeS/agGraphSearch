...
if(F){
#2019
agVisNetwork(Graph=Dat02[grepl("mesh2019[:]", Dat01$subject),],
             Selected=NULL, 
             Browse=FALSE, 
             Output=TRUE,
...
#2020
agVisNetwork(Graph=Dat02[grepl("mesh2020[:]", Dat01$subject),],
             Selected=NULL, 
             Browse=FALSE, 
             Output=TRUE,
...
#2021
agVisNetwork(Graph=Dat02[grepl("mesh[:]", Dat01$subject),],
             Selected=NULL, 
             Browse=FALSE, 
             Output=TRUE,
...
```{r echo=TRUE, eval=FALSE}
#2021 + Jpn
Dat <- readRDS("./02_Mesh_Out/Dat02.Rds")
Dat03 <- Dat[grepl("mesh[:]", Dat$subject),]
head(Dat03)
