...
#Source script
source(system.file("script", "srachWikidataPolyInfo.R", package="agGraphSearch"))
...
#Save
#saveRDS(QID.d, "./04_Wiki_PolyInfo_00/QID.d.Rds")
#Re-load
#QID.d <- readRDS("./04_Wiki_PolyInfo_00/QID.d.Rds")
```
