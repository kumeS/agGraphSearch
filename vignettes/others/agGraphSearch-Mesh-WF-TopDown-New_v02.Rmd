...
words <- data.frame(readr::read_csv("./00_Mesh_Input/高分子辞典OCR_2column_en.csv", col_names = F, show_col_types = F))
...
table(MeshLabels$SubInfo, MeshLabels$Property)
...
#小文字変換
MeshLabelsR <- readRDS("./00_Mesh_Input/MeshLabelsR.Rds")
head(MeshLabelsR); dim(MeshLabelsR)
MeshLabels01 <- unique(tolower(MeshLabelsR$Object))
head(MeshLabels01)
length(MeshLabels01)
table(MeshLabelsR$Property)
...
#saveRDS(Dat, "./01_Mesh_Out/Dat_OCR_en_match.Rds")
...
#saveRDS(words02, "./01_Mesh_Out/Dat_OCR_en_words02.Rds")
...
words02 <- readRDS("./01_Mesh_Out/Dat_OCR_en_words02.Rds")
head(words02)
dim(words02)
...
#######################################
#Save
#saveRDS(words02, "./01_Mesh_Out/OCR_en2jpn_words02.Rds")
#readr::write_excel_csv(words02, file="./01_Mesh_Out/OCR_en2jpn_words02.csv", col_names = T, append=F)
#######################################
```
...
words02 <- readRDS("./01_Mesh_Out/OCR_en2jpn_words02.Rds")
head(words02)
dim(words02)
...
head(LabList00)
length(LabList00)
saveRDS(LabList00, "./01_Mesh_Out/OCR_en_LabList00.Rds")
...
#words
LabList00 <- readRDS("./01_Mesh_Out/OCR_en_LabList00.Rds")
LabList00
str(LabList00)
...
head(Dat); dim(Dat)
length(unique(c(Dat$subject, Dat$parentClass)))
#saveRDS(Dat, "./02_Mesh_Out/OCR_en_downClass.Rds")
...
#rm(list=ls())
MeshLabelR <- readRDS("./00_Mesh_Input/MeshLabelsR.Rds")
upClass <- readRDS("./02_Mesh_Out/OCR_en_upClass.Rds")
downClass <- readRDS("./02_Mesh_Out/OCR_en_downClass.Rds")
Dat <- readRDS("./02_Mesh_Out/OCR_en_downClass.Rds")
...
#saveRDS(Dat00, "./02_Mesh_Out/OCR_Dat02.Rds")
...
##################################################################
a <- readRDS("./02_Mesh_Out/OCR_DatJpn02.Rds")
head(a)
...
#Save
saveRDS(DatJpn03, "./02_Mesh_Out/OCR_DatJpn03_new.Rds")
...
suppressMessages(filesstrings::move_files(FileName, "./03_Mesh_Out_OCR_Jpn"))
}
...
```{r echo=TRUE, eval=FALSE}
#rm(list=ls())
#dir.create("04_Mesh_Out_OCR_RDF")
Dat02 <- readRDS("./02_Mesh_Out/OCR_Dat02.Rds")
DatJpn03 <- readRDS("./02_Mesh_Out/OCR_DatJpn02.Rds")
topClass <- unique(DatJpn03$parentClass)[!(unique(DatJpn03$parentClass) %in% unique(DatJpn03$subject))]
LabList00 <- readRDS("./01_Mesh_Out/OCR_en_LabList00.Rds")
...
write.table(nt, "./04_Mesh_Out_OCR_RDF/RDF_from_mesh_v01.nt", sep="",
...
##################################################################
#集計
e <- readLines("./04_Mesh_Out_OCR_RDF/RDF_from_mesh_v01.nt")
str(e)
length(unique(e))
write.table(data.frame(X=e), "./04_Mesh_Out_OCR_RDF/RDF_from_mesh_v01.nt", sep="",
             row.names = F, col.names = F, append=F, quote = F)
##################################################################

e <- getwd()
file <- "/04_Mesh_Out_OCR_RDF/RDF_from_mesh_v01.nt"
i <- "/Users/sk/Desktop/AllegroGraph/ssh/id_rsa"
paste("scp -i ",  i, " -r ", e, file, " admin@172.17.42.44:/data1/NEDO", sep="")
